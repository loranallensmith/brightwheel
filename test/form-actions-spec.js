...
describe('FormActions', () => {
  ...
  describe('render', () => {
    ...
    it('should create the right element', () => {
      ...
      expect(myActions.element.tagName).to.equal('DIV');
    });

    it('should render the correct class', () => {
      let myActions = new FormActions({}, []);
      expect(myActions.element.className).to.include('form-actions');
    });

    it('should include extra classes', () => {
      let myActions = new FormActions({ text: 'My FormActions', classNames:['extra-class', 'another-class']}, []);
      expect(myActions.element.className).to.contain('extra-class another-class');
    });
