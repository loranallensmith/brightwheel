...
class Pane extends BrightwheelComponent {

  render() {
    let classes = classNames(
      'pane', {
        [`pane-${this.properties.size}`]: this.properties.size !== undefined,
        'sidebar': this.properties.sidebar === true
      },
      this.properties.classNames
    );

    return (
      <div {...this.properties.attributes} className={classes} on={{
        click: this.onClick,
        copy: this.onCopy,
        cut: this.onCut,
        paste: this.onPaste,
